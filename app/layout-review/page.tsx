    ...
    <div className="grid gap-6 xl:grid-cols-[1.7fr_1fr]">
      <Card>
        <div className="mb-3 flex items-center justify-between">
          <h3 className="text-lg font-semibold">6年1組 レイアウトプレビュー</h3>
          <StatusBadge tone="info">Auto Layout v0.9 (Mock)</StatusBadge>
        </div>
        <p className="text-sm text-slate-400">卒業アルバム向けの自動配置案です。微調整のみ可能な想定。</p>

        <div className="mt-4 rounded-xl border border-slate-700 bg-slate-950/60 p-4">
          <p className="mb-2 text-xs text-slate-400">担任エリア</p>
          <div className="mb-4 flex gap-3">
            <div className="relative h-24 w-24 overflow-hidden rounded-lg border border-slate-700"><Image src="https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?auto=format&fit=crop&w=200&q=80" alt="teacher" fill className="object-cover" unoptimized /></div>
            <div className="relative h-24 w-24 overflow-hidden rounded-lg border border-slate-700"><Image src="https://images.unsplash.com/photo-1595152772835-219674b2a8a6?auto=format&fit=crop&w=200&q=80" alt="teacher" fill className="object-cover" unoptimized /></div>
          </div>

          <p className="mb-2 text-xs text-slate-400">生徒エリア</p>
